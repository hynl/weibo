 ...
 */
public class MyNewFriendsActivity extends BaseActivity implements View.OnClickListener{
    int next_cursor;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        footView = View.inflate(MyNewFriendsActivity.this, R.layout.footview_loading, null);

        loadData(0);
    }
    private void loadData(final int page){
        HynlWeiboAPI weiboAPI = new HynlWeiboAPI(MyNewFriendsActivity.this);
        weiboAPI.friends(mAccessToken.getUid(), 100, page, new SimpleRequestListener(MyNewFriendsActivity.this, null) {
            @Override
